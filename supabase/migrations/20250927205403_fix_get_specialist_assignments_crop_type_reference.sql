-- Fix get_specialist_assignments function to remove any crop_type references
-- This migration ensures the function works correctly with the current farmers table schema

-- Drop and recreate the get_specialist_assignments function
DROP FUNCTION IF EXISTS public.get_specialist_assignments(uuid);

-- Recreate get_specialist_assignments function without crop_type references
